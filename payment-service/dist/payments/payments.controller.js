...
let PaymentsController = class PaymentsController {
    ...
    create(dto, res) {
        ...
        res.status(created ? common_1.HttpStatus.CREATED : common_1.HttpStatus.OK).json(payment);
    }
...
__decorate([
    (0, common_1.Get)('by-reservation/:reservationId/status'),
    __param(0, (0, common_1.Param)('reservationId', new common_1.ParseUUIDPipe())),
    __metadata("design:type", Function),
